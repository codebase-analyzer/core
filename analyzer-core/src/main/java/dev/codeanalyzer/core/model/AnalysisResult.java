...
public class AnalysisResult {
    ...
    /** Per-finding auto-fix patches generated by {@code AutoFixEngine}. Empty when no fixer matched. */
    private Map<Finding, Patch> availableFixes = Collections.emptyMap();
    ...
    /** Patches available for any of the findings in this result (may be empty). */
    public Map<Finding, Patch> getAvailableFixes() { return availableFixes; }
    public void setAvailableFixes(Map<Finding, Patch> fixes) {
        this.availableFixes = fixes != null
                ? Collections.unmodifiableMap(new java.util.LinkedHashMap<Finding, Patch>(fixes))
                : Collections.<Finding, Patch>emptyMap();
    }
